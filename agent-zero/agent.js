...
async function runAgent() {
  try {
    log("🔍 Polling JSK8SNXZ cluster for audit nodes...");
    ...
    for (const lead of leads) {
      log(`📝 Auditing: ${lead.business_name}`);
      ...
      try {
        const response = await ai.models.generateContent({
          ...
          contents: `Audit Business: ${lead.business_name}. Return 0-100 Digital Readiness Score and 1-sentence growth advice.`,
    ...
    log("❌ Critical Infrastructure Error:", err.message);
  }
}
