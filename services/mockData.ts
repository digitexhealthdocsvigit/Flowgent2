...
export const MOCK_LEADS: Lead[] = [
  { id: '1', businessName: 'TechNova Solutions', category: 'IT Services', email: 'hello@technova.com', websiteUrl: 'https://technova.io', city: 'Bangalore', status: 'discovered', score: 45, temperature: 'warm', createdAt: '2023-11-20', orgId: 'org1' },
  { id: '2', businessName: 'GreenLeaf Realty', category: 'Real Estate', email: 'sales@greenleaf.in', websiteUrl: 'https://greenleafrealty.com', city: 'Mumbai', status: 'audit_viewed', score: 78, temperature: 'hot', createdAt: '2023-11-21', orgId: 'org2' },
  { id: '3', businessName: 'Peak Performance Gym', category: 'Fitness', email: 'peakgym@gmail.com', websiteUrl: 'https://peakgym.com', city: 'Delhi', status: 'form_submitted', score: 12, temperature: 'cold', createdAt: '2023-11-22', orgId: 'org1' },
  { id: '4', businessName: 'Royal Spices Exports', category: 'Manufacturing', email: 'info@royalspices.com', websiteUrl: 'https://royalspices.com', city: 'Kochi', status: 'calendar_booked', score: 92, temperature: 'hot', createdAt: '2023-11-23', orgId: 'org1' },
  { id: '5', businessName: 'BlueSky Clinics', category: 'Healthcare', email: 'contact@blueskyclinics.com', websiteUrl: 'https://blueskyclinics.in', city: 'Pune', status: 'discovered', score: 30, temperature: 'warm', createdAt: '2023-11-24', orgId: 'org1' },
  { id: '6', businessName: 'Elite Motors', category: 'Automotive', email: 'sales@elitemotors.com', websiteUrl: 'https://elitemotors.co.in', city: 'Gurgaon', status: 'proposal_sent', score: 85, temperature: 'hot', createdAt: '2023-11-25', orgId: 'org1' },
];
